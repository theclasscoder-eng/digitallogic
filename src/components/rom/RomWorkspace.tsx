    ...
    <div className="grid h-full min-h-0 grid-cols-1 gap-4 overflow-hidden lg:grid-cols-[380px_minmax(0,1fr)]">
      <section className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-soft">
        ...
        <div className="mt-3 grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_auto] gap-3 overflow-hidden">
          <ScrollableSection title="Input Variables" className="min-h-0">
            <div className="space-y-2">
              <textarea
                ...
                className="h-20 w-full rounded-lg border border-slate-300 px-3 py-2 font-mono text-sm text-slate-800 focus:border-cyan-500 focus:outline-none"
                placeholder="A, B, Bin"
              />
              <button
                type="button"
          ...
          <ScrollableSection title="Output Functions" className="min-h-0">
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[11px] font-semibold text-slate-500">Define expressions or truth bits.</span>
                <button
                  type="button"
          ...
          <ScrollableSection title="ROM Tools" className="min-h-0">
