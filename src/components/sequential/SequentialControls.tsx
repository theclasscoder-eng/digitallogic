    ...
    <section className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-soft">
      ...
      <div className="mt-3 space-y-3 overflow-y-auto pr-1">
        <div className="flex items-center gap-2">
          <label className="text-xs font-bold uppercase tracking-wide text-slate-500">Component</label>
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-wide text-slate-500">Input Toggles</p>
